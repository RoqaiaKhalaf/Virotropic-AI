...
# --- التنسيق الجمالي (ضبط اللوجو والعنوان) ---
st.markdown("""
<style>
...
# عرض اللوجو والعنوان بشكل مدمج
with st.container():
    col1, col2, col3 = st.columns([1, 1, 1])
    with col2:
        try:
            st.image("logo.png", width=100) # تم تقليل الحجم قليلاً للتناسق
        except:
            st.markdown("<h1 style='text-align:center;'>🔬</h1>", unsafe_allow_html=True)

st.markdown("""
<div class="hero-container">
    <h1 class="hero-title">ViroTropic AI</h1>
    <p class="hero-subtitle">Intelligent Medical Research Assistant</p>
</div>
""", unsafe_allow_html=True)
...
with st.sidebar:
    ...
    for chat_id, chat_data in st.session_state.chat_sessions.items():
        ...
        st.button(chat_data["title"], key=f"btn_{chat_id}", on_click=switch_chat, args=(chat_id,),
...
if not session["messages"]:
    ...
    <div class="welcome-box">
        ...
        <p>I am your AI assistant specialized in Tropical Medicine, how can I help you today?</p>
    </div>
    """, unsafe_allow_html=True)
...
if query:
    ...
    with st.spinner("Analyzing research database..."):
        ...
        session["messages"].append({"role": "assistant", "content": response.content, "citations": apa_citations})
